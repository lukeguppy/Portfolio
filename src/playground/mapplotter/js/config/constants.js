const COMMON_CATEGORIES = {
    ...
    'hospital': { key: 'amenity', value: 'hospital', label: 'Hospitals', examples: 'hospital, medical center' },
    ...
    'fitness_centre': { key: 'leisure', value: 'fitness_centre', label: 'Fitness Centers', examples: 'gym, fitness center' },
    'park': { key: 'leisure', value: 'park', label: 'Parks', examples: 'park, recreation' },
    'swimming_pool': { key: 'leisure', value: 'swimming_pool', label: 'Swimming Pools', examples: 'swimming pool, leisure center' },
...
const DEFAULT_PIN_COLOR = '#4ECDC4';
